...
export default function NovoLancamento() {
  ...
  }, [lancamento.isRecorrente, lancamento.periodicidade, lancamento.dataInicial, lancamento.dataFinal])
  ...
  return (
    <div className="container mx-auto py-10">
      <h1 className="mb-8 text-2xl font-semibold text-[#0078FF]">Novo Lançamento</h1>
